...
import com.waenhancer.activities.StatusForwardRulesActivity;
...
public class StatusForwardRulesPreference extends Preference
    ...
    private void updateSummary(Context context) {
        ...
        setSummary(count == 0
                ? context.getString(com.waenhancer.R.string.rules_summary_empty)
                : context.getString(com.waenhancer.R.string.rules_summary_count, count));
    }
